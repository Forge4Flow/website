...
export default function Header02() {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center px-6 xl:px-24 py-4 ">
          <Link className="shrink-0" href="/">
            <Image src={Logo} width={200} alt="Forge4Flow" />
          </Link>
          {/* End  logo */}
            ...
            <nav className="navbar w-full">
              <ul className="flex flex-col lg:flex-row">
                ...
                {/* <li className="group" onClick={() => setToggle(false)}>
                  <Link href="/cloud">
                    <button className="text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5">
                      <span
                        className={
                          isChildrenPageActive("/cloud", route.asPath)
                ...
                <li className="js-nav-dropdown nav-item dropdown group relative">
                  ...
                  <ul
                    className="dropdown-menu dark:bg-jacarta-800 -left-6 top-[85%] z-10 hidden grid-flow-col grid-rows-4 gap-x-4 whitespace-nowrap rounded-xl bg-white transition-all will-change-transform group-hover:visible group-hover:opacity-100 lg:invisible lg:absolute lg:!grid lg:translate-y-4 lg:py-8 lg:px-5 lg:opacity-0 lg:shadow-2xl lg:group-hover:translate-y-2 relative"
